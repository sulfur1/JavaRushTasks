...
public class Solution {
    ...
    //int flag = ((Date) stock2.get("date")).compareTo((Date) stock1.get("date"));
    /*int flag;
    Double profit1;
    Double profit2;
    ...
    flag = profit2.compareTo(profit1);
    */
    public static void sort(List<Stock> list) {
        ...
        list.sort(new Comparator<Stock>() {
            @Override
            public int compare(Stock stock1, Stock stock2) {
                int flag = ((String) stock1.get("name")).compareTo((String) stock1.get("name"));
                if (flag == 1) {
                    return 1;
                } else if (flag == -1) {
                    return -1;
